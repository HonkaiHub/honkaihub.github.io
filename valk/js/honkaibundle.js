...
module.exports=import data from '../json/AiHyperion/info.json' assert { type: 'JSON' };
console.log(data);

},{}],3:[function(require,module,exports){
module.exports=import data from '../json/Aponia/info.json' assert { type: 'JSON' };
console.log(data);

},{}],4:[function(require,module,exports){
module.exports=import data from '../json/AsukaShikinamiLangley/info.json' assert { type: 'JSON' };
console.log(data);

},{}],5:[function(require,module,exports){
module.exports=import data from '../json/BiankaAtaegina/info.json' assert { type: 'JSON' };
console.log(data);

},{}],6:[function(require,module,exports){
module.exports=import data from '../json/BronyaZaychik/info.json' assert { type: 'JSON' };
console.log(data);

},{}],7:[function(require,module,exports){
module.exports=import data from '../json/CarolePeppers/info.json' assert { type: 'JSON' };
console.log(data);

},{}],8:[function(require,module,exports){
module.exports=import data from '../json/Eden/info.json' assert { type: 'JSON' };
console.log(data);

},{}],9:[function(require,module,exports){
module.exports=import data from '../json/Elysia/info.json' assert { type: 'JSON' };
console.log(data);

},{}],10:[function(require,module,exports){
module.exports=import data from '../json/Fischl/info.json' assert { type: 'JSON' };
console.log(data);

},{}],11:[function(require,module,exports){
module.exports=import data from '../json/FuHua/info.json' assert { type: 'JSON' };
console.log(data);

},{}],12:[function(require,module,exports){
module.exports=import data from '../json/Griseo/info.json' assert { type: 'JSON' };
console.log(data);

},{}],13:[function(require,module,exports){
module.exports=import data from '../json/HimekoMurata/info.json' assert { type: 'JSON' };
console.log(data);

},{}],14:[function(require,module,exports){
module.exports=import data from '../json/KallenKaslana/info.json' assert { type: 'JSON' };
console.log(data);

},{}],15:[function(require,module,exports){
module.exports=import data from '../json/KianaKaslana/info.json' assert { type: 'JSON' };
console.log(data);

},{}],16:[function(require,module,exports){
module.exports=import data from '../json/LiliyaOlenyeva/info.json' assert { type: 'JSON' };
console.log(data);

},{}],17:[function(require,module,exports){
module.exports=import data from '../json/LiSushang/info.json' assert { type: 'JSON' };
console.log(data);

},{}],18:[function(require,module,exports){
module.exports=import data from '../json/MeiRaiden/info.json' assert { type: 'JSON' };
console.log(data);

},{}],19:[function(require,module,exports){
module.exports=import data from '../json/Mobius/info.json' assert { type: 'JSON' };
console.log(data);

},{}],20:[function(require,module,exports){
module.exports=import data from '../json/NatashaCioara/info.json' assert { type: 'JSON' };
console.log(data);

},{}],21:[function(require,module,exports){
module.exports=import data from '../json/Pardofelis/info.json' assert { type: 'JSON' };
console.log(data);


},{}],22:[function(require,module,exports){
module.exports=import data from '../json/RitaRossweisse/info.json' assert { type: 'JSON' };
console.log(data);

},{}],23:[function(require,module,exports){
module.exports=import data from '../json/RozaliyaOlenyeva/info.json' assert { type: 'JSON' };
console.log(data);

},{}],24:[function(require,module,exports){
module.exports=import data from '../json/SeeleVollerei/info.json' assert { type: 'JSON' };
console.log(data);

},{}],25:[function(require,module,exports){
module.exports=import data from '../json/SusannahManatt/info.json' assert { type: 'JSON' };
console.log(data);

},{}],26:[function(require,module,exports){
module.exports=import data from '../json/TheresaApocalypse/info.json' assert { type: 'JSON' };
console.log(data);

},{}],27:[function(require,module,exports){
module.exports=import data from '../json/VillV/info.json' assert { type: 'JSON' };
console.log(data);

},{}],28:[function(require,module,exports){
module.exports=import data from '../json/YaeSakura/info.json' assert { type: 'JSON' };
console.log(data);
